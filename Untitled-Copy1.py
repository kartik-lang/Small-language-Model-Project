...
# It cannot wipe the entire environment (conda env, installed pip packages) like Colab can, because your local machine controls the environment.
# It can only reset RAM, variables, and running state.
import os
os._exit(0)
